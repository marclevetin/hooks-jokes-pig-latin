...
const PigLatinContext = React.createContext({
    translate: usePigLatin,
});

function usePigLatin(string) {
    try {
        return string.split(' ')
                    .map(word => {
        ...
        console.error('Problem with this joke:');
        console.error(error.message);
    }
}

export default PigLatinContext